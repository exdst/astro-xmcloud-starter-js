...
import { SearchDocument, SearchFieldsMapping, SearchDictionary } from '../models';
...
export const SearchItem = ({
  ...
  const components = (
    <>
      ...
      {fields.link && <SearchItemLink link={fields.link} onClick={onClick} dictionary={dictionary} />}
    </>
  );
